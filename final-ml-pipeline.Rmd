...
# For Model #2, we are using 95% of the dataset to train the model because we have a huge dataset and we can use it to our advantage
...
sum(is.na(model_df))
# Perform train-test split (stratified)
target_column = "total_sum"
split <- sample.split(model_df[, target_column], SplitRatio = 0.90)
